...
def drawTrack(x,y):
    ...
    screen.blit(trackImage6,(x+400,y+1100))
...
def drawBack():
    ...
    screen.blit(trackBG,(backPos[0]-200,backPos[1]+600))
    if windowHeight > 600:
        screen.blit(trackBG,(backPos[0]+1200,backPos[1]+800))
        screen.blit(trackBG,(backPos[0]+1000,backPos[1]+800))
        screen.blit(trackBG,(backPos[0]+800,backPos[1]+800))
        screen.blit(trackBG,(backPos[0]+600,backPos[1]+800))
        screen.blit(trackBG,(backPos[0]+400,backPos[1]+800))
        screen.blit(trackBG,(backPos[0]+200,backPos[1]+800))
        screen.blit(trackBG,(backPos[0],backPos[1]+800))
        screen.blit(trackBG,(backPos[0]-200,backPos[1]+800))
    if windowHeight > 800:
        screen.blit(trackBG,(backPos[0]+1200,backPos[1]+1000))
        screen.blit(trackBG,(backPos[0]+1000,backPos[1]+1000))
        screen.blit(trackBG,(backPos[0]+800,backPos[1]+1000))
        screen.blit(trackBG,(backPos[0]+600,backPos[1]+1000))
        screen.blit(trackBG,(backPos[0]+400,backPos[1]+1000))
        screen.blit(trackBG,(backPos[0]+200,backPos[1]+1000))
        screen.blit(trackBG,(backPos[0],backPos[1]+1000))
        screen.blit(trackBG,(backPos[0]-200,backPos[1]+1000))
    if windowWidth > 1000:
        screen.blit(trackBG,(backPos[0]+1400,backPos[1]-200))
        screen.blit(trackBG,(backPos[0]+1400,backPos[1]))
        screen.blit(trackBG,(backPos[0]+1400,backPos[1]+200))
        screen.blit(trackBG,(backPos[0]+1400,backPos[1]+400))
        screen.blit(trackBG,(backPos[0]+1400,backPos[1]+600))
        screen.blit(trackBG,(backPos[0]+1400,backPos[1]+800))
        screen.blit(trackBG,(backPos[0]+1400,backPos[1]+1000))
...
while (GameStart == "Standard"):
    ...
    if moveUp:
        carSpeed = speed(speedX, speedY)
        position = [position[0] + dx, position[1] - dy]

    #timer
    #minutes, seconds, milliseconds = timer(minutes, seconds, milliseconds)
    #timelabel = basicFont.render("{}:{}".format(seconds, milliseconds), True, (0,0,0))
